...
const AllDay = ({
  ...
  return (
    ...
    >
      ...
      <Text style={styles.text}>High: {maxtempC}</Text>
      <Text style={styles.text}>Low: {mintempC}</Text>
      <Text style={styles.text}>High: {maxtempF}</Text>
      <Text style={styles.text}>Low: {mintempF}</Text>
      ...
      >
        <ScrollView style={styles.inputText}>
          <Text
            style={[
              styles.text,
              { fontFamily: "Menlo", fontSize: 30, color: "#f50c46" }
            ]}
          >
            Weather
          </Text>
